        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900">ViloAi Dashboard</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!profile?.instagram_connected ? (
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-purple-700 mb-4">
              Connect your Instagram Business account to start analyzing messages and gaining insights.
            </p>
            <button
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-green-700">
                  Your Instagram Business account is connected and ready to sync messages.
                </p>
              </div>
              <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              {followers.length === 0 ? (
                <p className="text-gray-500 text-center py-8">No follower data yet</p>
              ) : (
...
function MessageCard({ message }: { message: InstagramMessage }) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4">
      ...
      {message.ai_reply_suggestion_en && (
        <div className="mt-3 pt-3 border-t border-gray-100">
          <p className="text-xs font-medium text-gray-600 mb-1">AI Suggestion (EN):</p>
          <p className="text-sm text-gray-700">{message.ai_reply_suggestion_en}</p>
        </div>
      )}
    </div>
  );
    ...
    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">{follower.message_count} messages</p>
        </div>
      </div>
      <div className="flex items-center space-x-2">
