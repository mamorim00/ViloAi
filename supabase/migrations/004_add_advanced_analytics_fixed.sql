-- Migration 004: Add Advanced Analytics and Onboarding
-- Fixed version without DATE() function in index

-- Add response time tracking to messages
ALTER TABLE instagram_messages
ADD COLUMN IF NOT EXISTS response_time_minutes INTEGER;

-- Add indexes for analytics queries (FIXED - removed DATE() function)
